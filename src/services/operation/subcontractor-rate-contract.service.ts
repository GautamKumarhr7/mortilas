...
export class SubcontractorRateContractService {
  ...
  constructor() {
    this.subcontractorRateContractRepository = new SubcontractorRateContractRepository();
  }

  async getAllSubcontractorRateContracts(): Promise<SubcontractorRateContract[]> {
