...
import { Attendance, NewAttendance } from '../models/attendance.model.js';
...
export class AttendanceService {
  ...
  async updateAttendance(id: number, attendanceData: Partial<NewAttendance>): Promise<Attendance | undefined> {
