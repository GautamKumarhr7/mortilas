...
export const subcontractorRateContracts = pgTable(
  "subcontractor_rate_contracts",
  {
...
export type SubcontractorRateContract =
  typeof subcontractorRateContracts.$inferSelect;
export type NewSubcontractorRateContract =
  typeof subcontractorRateContracts.$inferInsert;
