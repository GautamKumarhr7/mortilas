...
export const subcontractorTdsTypeEnum = pgEnum('subcontractor_tds_type', ['Individual', 'Company']);

export const subcontractors = pgTable('subcontractors', {
  id: uuid('id').primaryKey(),
  subcontractorCode: varchar('subcontractor_code', { length: 255 }).notNull().unique(),
